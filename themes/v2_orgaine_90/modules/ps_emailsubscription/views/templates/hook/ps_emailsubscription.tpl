...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    {strip}
    <div class="tvcms-newsletter-wrapper container-fluid" {* style="background-image:url({$Newsletterpath}{$NewsletterBackgroundImage})" *}>
        <div class="tvcms-newsletter-inner container">
            <div class="block_newsletter tv-newsletter-wrapeer">
                <div class="tvnewsletter-block">
                    <div class="tvnewsletter-lable-wrapper">
                        {if Configuration::get('TVCMSCUSTOMSETTING_NEWSLETTER_SUB_TITLE', $language.id)}
                        <p id="block-newsletter-label" class="tvnewsletter-subtitle">
                            {Configuration::get('TVCMSCUSTOMSETTING_NEWSLETTER_SUB_TITLE', $language.id)}
                        </p>
                        {/if}
