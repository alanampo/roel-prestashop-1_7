...
{strip}
    ...
    <div class="block-social tvcmsfooter-social-icon col-xl-6 col-md-6 col-sm-12">
            ...
            *}{if !empty(Configuration::get('BLOCKSOCIAL_FACEBOOK' , $language.id))}
            <li class="facebook">
                <a href="{Configuration::get('BLOCKSOCIAL_FACEBOOK')}" rel="noreferrer" title="{l s='Facebook' d='Shop.Theme.Catalog'}">
                    ...
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f" role="img" viewBox="0 0 320 512">
            ...
            <li class="twitter">
                <a href="{Configuration::get('BLOCKSOCIAL_TWITTER')}" rel="noreferrer" title="{l s='Twitter' d='Shop.Theme.Catalog'}">
                    ...
                    *}
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" viewBox="0 0 512 512">
            ...
            <li class="rss">
                <a href="{Configuration::get('BLOCKSOCIAL_RSS')}" rel="noreferrer" title="{l s='Rss' d='Shop.Theme.Catalog'}">
                    ...
                    <svg class="tvblock-social-icon tvrss" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="rss" class="svg-inline--fa fa-rss fa-w-14" role="img" viewBox="0 0 448 512">
            ...
            <li class="youtube">
                <a href="{Configuration::get('BLOCKSOCIAL_YOUTUBE')}" rel="noreferrer" title="{l s='Youtube' d='Shop.Theme.Catalog'}">
                    ...
                    *}
                     <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="youtube" role="img" viewBox="0 0 576 512">
            ...
            <li class="googleplus">
                <a href="{Configuration::get('BLOCKSOCIAL_GOOGLE_PLUS')}" rel="noreferrer" title="{l s='Google plus' d='Shop.Theme.Catalog'}">
                    ...
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google-plus-g" role="img" viewBox="0 0 640 512">
            ...
            <li class="pinterest">
                <a href="{Configuration::get('BLOCKSOCIAL_PINTEREST')}" rel="noreferrer" title="{l s='Pinterest' d='Shop.Theme.Catalog'}">
                    ...
                    *}
                    <svg class="tvblock-social-icon tvpinterest" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="pinterest-p" class="svg-inline--fa fa-pinterest-p fa-w-12" role="img" viewBox="0 0 384 512">
            ...
            <li class="vimeo">
                <a href="{Configuration::get('BLOCKSOCIAL_VIMEO')}" rel="noreferrer" title="{l s='Vimeo' d='Shop.Theme.Catalog'}">
                    ...
                    *}
                    <svg class="tvblock-social-icon tvvimeo" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="vimeo-v" class="svg-inline--fa fa-vimeo-v fa-w-14" role="img" viewBox="0 0 448 512">
            ...
            <li class="instagram">
                <a href="{Configuration::get('BLOCKSOCIAL_INSTAGRAM')}" rel="noreferrer" title="{l s='Instagram' d='Shop.Theme.Catalog'}">
                    ...
                    *}
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" viewBox="0 0 448 512">
