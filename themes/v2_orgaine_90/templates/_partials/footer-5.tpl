...
{strip}
    ...
    <div class="footer-container tvcmsfooter-background-image footer-5" data-footer-layout="5" {if $FooterImageStatus}style="background-image: url('{$paths}{$FooterBackgroundImage}');" {/if}> <div class="container tvfooter-logo-link-wrapper">
