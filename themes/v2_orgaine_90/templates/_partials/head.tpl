...
<link as="style" rel="stylesheet preload" type="text/css" href="{$urls.css_url}caveat.css" />
<link as="style" rel="stylesheet preload" type="text/css" href="{$urls.css_url}montserrat.css" />
{if $ArabicFontStatus}
