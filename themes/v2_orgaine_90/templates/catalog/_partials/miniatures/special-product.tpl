    ...
    *}
    ...
    <article class="product-miniature js-product-miniature tvall-product-wrapper-info-box" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
        <div class="tvproduct-wrapper">
            <div class="tvproduct-img-box-wrapper col-xl-6 col-lg-6 col-md-6 col-xs-12">
                {block name='product_thumbnail'}
                <div class="tvproduct-image">
                    {if $product.cover}
                    <a href="{$product.url}" class="thumbnail product-thumbnail" itemprop="url">
                        <img src="{$product.cover.bySize['sp_pd_main_img']['url']}" alt="{if !empty($product.cover.legend)}{$product.cover.legend}{else}{$product.name}{/if}" class="tvproduct-defult-img tv-img-responsive tvcms-main-special-img" height="{$product.cover.bySize['sp_pd_main_img']['height']}" width="{$product.cover.bySize['sp_pd_main_img']['width']}" itemprop="image" loading="lazy">
                        {if Configuration::get('TVCMSCUSTOMSETTING_HOVER_IMG')}
                        {if isset($product.images.0.bySize['sp_pd_main_img']['url']) && empty($product.images.0.cover)}
                        <img class="tvproduct-hover-img tv-img-responsive" src="{$product.images.0.bySize['sp_pd_main_img']['url']}" alt="{$product.name}" height="{$product.images.0.bySize['sp_pd_main_img']['height']}" width="{$product.images.0.bySize['sp_pd_main_img']['width']}" itemprop="image" loading="lazy">
                        {elseif isset($product.images.1.bySize['sp_pd_main_img']['url']) && empty($product.images.1.cover)}
                        <img class="tvproduct-hover-img tv-img-responsive" src="{$product.images.1.bySize['sp_pd_main_img']['url']}" alt="{$product.name}" height="{$product.images.1.bySize['sp_pd_main_img']['height']}" width="{$product.images.1.bySize['sp_pd_main_img']['width']}" itemprop="image" loading="lazy">
                        {/if}
                        {/if}
                    </a>
                    {else}
                    <a href="{$product.url}" class="thumbnail product-thumbnail">
                        <img class="tv-img-responsive" src="{$urls.no_picture_image.bySize['sp_pd_main_img']['url']}" height="{$urls.no_picture_image.bySize['sp_pd_main_img']['height']}" width="{$urls.no_picture_image.bySize['sp_pd_main_img']['width']}" itemprop="image" loading="lazy">
                    </a>
                    {/if}
                    ...
                    <ul class="discount-percentage  discount-product tvproduct-discount-price tvproduct-flags">
            ...
            <div class="tvproduct-info-box-wrapper col-xl-6 col-lg-6 col-md-6 col-xs-12">
